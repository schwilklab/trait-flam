...
double FBL_SurfaceFireEllipsePsiDegrees(
            double f,
            double h,
            double thetaDegrees ) ;

double FBL_SurfaceFireEllipsePsiRadians(
            double f,
            double h,
            double thetaRadians ) ;

double FBL_SurfaceFireEllipseThetaDegrees(
            double f,
            double g,
            double h,
            double betaDegrees ) ;

double FBL_SurfaceFireEllipseThetaRadians(
            double f,
            double g,
            double h,
            double betaRadians ) ;
