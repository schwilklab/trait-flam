...
\abstract{ Moisture content is a strong determinant of forest fuel flammability
  ...
  typified by different tree genera. Finally, we found that litter mixtures
  exhibited consistent non-additivity in flame spread rate in fuel consumption.
  This non-additivity became more positive with fuel drying. Litter mixtures
  burn with fire behavior more similar to that of the most flammable
  constituent species and this effect increases as fuels dry. ADD Synthesis
  statement.}
...
\cite{Knapp_Schwilk_etal-2006, Kreye_Hiers_etal-2018}.


% Fine fuel moisture content reduces ignition probability and flame spread rate \cite{Gisborne-1936,   Fons-1946, Anderson+Rothermal-1965}.
...
morphology, especially leaf cuticle thickness \cite{Van_Wagner-1969}. Drying
...
\cite{Scarff+Westoby-2006}. Fuel-beds composed of larger leaves with lower
...
\cite{Skaug_Fournier_etal-2016} to model percent fuel consumed as a function
...
\begin{table}[H]
  \caption{Generalized linear mixed model results for two models predicting
    ...
    approximation \cite{Kenward_Roger-1997}. Estimated coefficients are in SI
    Tables 2 and 4}
...
work in this system \cite{Magalhaes+Schwilk-2012} was that flammability trials
...
previously reported for \emph{Q. kelloggii} \cite{Magalhaes+Schwilk-2012} would
...
\cite{Magalhaes+Schwilk-2012}. Our results suggest that moisture dynamics are
...
Van Wagner \cite{Van_Wagner-1969}, investigating fuel weathering, found that
...
litter monocultures \cite[][, Table 2]{Magalhaes+Schwilk-2012}. If packing
...
\cite{Harris+Remenyi+etal-2016, Archibald+Lehmann+etal-2018}. The patterns we
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\acknowledgments{The authors thank the National Park Service and the employees
