...
\begin{abstract}
  \noindent \begin{enumerate}
    ...
    or taxon specific information to fire behavior prediction.
      ...
      \item To fill these gaps in knowledge, determined
...
Species differ in their litter flammability \cite{Fonda+Belanger+etal-1998,
  Fonda-2001, Scarf+Westoby-2006, Kane+Varner+etal-2008,
  Cornwell+Elvira+etal-2015}. Litter packing, measured as litter-bed density or
...
availability and burn with faster spread rates \citep{Scarf+Westoby-2006,
...
\citep{Fonda+Belanger+etal-1998, Stephens+Finney+etal-2004,
  ...
  Prior+Murphy+etal-2018}.

These species-specific effects are increasingly well established. However, how
moisture dynamics modulate species specific flammability is poorly known and
could be driven by by leaf traits, emergent litter traits, or by both. Species
...
fires \citep{Knapp_Schwilk_etal-2006, Kreye_Hiers_etal-2018}.

Fuel moisture content through time is controlled by two processes, absorption
and retention \citep{Kreye+Kobziar+etal-2013}. Absorptive capacity represents
...
saturation can indicate different abilities to retain moisture. Litter particle
...
Fuel-beds composed of larger leaves with lower moisture retainability should
...
\citep{Blauw+Wensink+etal-2015, Zhao+Cornwell+etal-2016}. It is possible that
...
in relation to two leaf and litter bed traits [CHECK AND FIX]. We then examined
the influence of moisture on the flammability across these species.
...
most flammable species. Here, we examined if this positive nonadditivity was
maintained in mixtures of varying levels of fuel moisture. The burn trials also
performed with multi-species litter mixtures to evaluate if there are
nonadditive effects as observed in oven-dried litter. We tested if the
nonadditive effects on reported in previous studies occur under [TODO CHECK]
ecologically-relevant moisture levels, and whether fuel moisture effects
strengthen or moderate such nonadditivity.
...
large bags. All litter was air dried to $< 5$\% fuel moisture by dry weight,
then weighed and divided into moisture trials. The collected litter was dried
in large batches, then stored in sealed plastic bags inside cardboard boxes in
a lab storage space. We minimized handling and moving the bagged litter to
avoid mechanical damage and changes to the particle size distributions. The
moisture manipulations and subsequent burning trials were conducted in
April--August 2015.
...
sample from a basket was less than 10\% moisture.
...
density). [TODO check] Specific leaf area was measured on freshly fallen litter
...
\citep{Schwilk-2015, Pausas+Keeley+etal-2017, Prior+Murphy+etal02018} and
...
also differences in drying rates across the eight species and estimated mixed
linear model slopes discriminated species into three groups from lowest to most
rapid: 1) \emph{C. decurrens}, 2) \emph{Abies spp} and \emph{S. giganteum}, and
3) \emph{Q. kelloggii} and \emph{Pinus spp} (SI Fig. 2).
...
the most flammable in terms of spread rate when dry. This highlights the
...
flammability might change under more [TODO FIX] realistic moisture levels. For
...
any Cupressaceae had the most rapid drying rate (SI Figure 4 and SI Table 8).
...
meeting ignition thresholds not met by the constituent species alone [TODO:
check wording]. To limit the number of models fit, we limited our investigation
...
flammability \citep{Schwilk-2015, Pausas+Keeley+etal-2017,
  Prior+Murphy+etal02018}. This result, together with previously published
