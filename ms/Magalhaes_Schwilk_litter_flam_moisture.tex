...
\caption{Dry down curves for eight litter types. Lines show best-fit
  ...
  horizontal jitter (0.5 hr) was added to this plot because, although
  collections were staggered, there were sometimes multiple samples collected
...
\caption{Flame spread rate by time since wetting for litter of eight species.
  ...
  (up to 2 hr) was added to the plot to avoid overplotting. All collections
  were at the times labeled on the x-axis. A lack of data at earlier time
  points for a taxon indicates no ignitions occurred at those time points.}
...
\caption{Percent fuel consumed by time since wetting for litter of eight
  ...
  Horizontal jitter (up to 2 hr) was added to the plot to avoid overplotting.
  All collections were at the times labeled on the x-axis. A lack of data at
  earlier time points for a taxon indicates no ignitions occurred at those time
  points.}
...
% (eg \emph{Qu)(eg \emph{Abies} branchlets with needles fitting between loosely
% packed \emph{Pinus} needles) or less dense
