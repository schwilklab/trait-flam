...
$^{2}$ \quad Texas Tech UnNiversity; dylan.schwilk@ttu.edu}
...
\abstract{ Moisture content is a strong determinant of forest fuel
  ...
  leading to mixtures of leaf litter on the surface fuelling the fires. Two
  studies have already established the existence of non-additive effects in the
  ...
  flammability of mixed litter. The litter from eight species of the
  ...
  of the litterbed. Species that produce more aerated litter beds (such as Q.
  kelloggii and the pines) have faster rates of litter desiccation. My results
  ...
  genus-specific behavior of flammability and time since wetting. I found
  non-additive effects in litter mixtures for both moisture content and
  flammability. Mixtures containing Q. kelloggii and P. jeffreyi, species that
...
Fuel moisture content is an important, and often driving, determinant of surface fire behavior. Environmental conditions such as temperature, relative humidity, and wind, drive the moisture content of the fuel available to burn [CITE]. In particular, fine dead fuels respond very readily to environmental changes [CITE]. In mixed-conifer forest of the western USA, where the fire regime is characterized by surface fires fuelled by plant litter, leaf traits can influence landscape scale fire behavior (Schwilk \& Caprio 2011). Litter packing (measured as litterbed density or packing ratio) controls the flammability of dry litter fuels in seasonally dry climates (higher litter density reduces flammability) and leaf litter packing is influenced by leaf size and shape (Fonda 1998, Kane et al. 2008, Schwilk \& Caprio 2011, Kreye et al. 2013). Fine fuel moisture content strongly reduces ignition probability and flame spread rate (Gisborne 1936, Fons 1946, Anderson \& Rothermel 1965, Xanthopoulos \& Wakimoto 1993, Dimitrakopoulos \& Papaioannou 2001, Weise et al. 2005, Pellizzaro et al. 2007). However, the mechanism by which both monospecific and mixed litterbeds absorb and desorb moisture is poorly known, and could be characterized by leaf traits, litter traits, or both.

Fuel moisture influences flammability and fire behavior through effects on ignition, spread rate, flame height, fuel consumption, and heat release, due to the high specific heat content of water (Rothermel 1972). Specifically, high moisture contents decrease the likelihood of ignition thereby reducing fire spread (Rothermel 1983, Nelson 2001). Moisture acts as a heat-sink resulting in less energy available for propagation, and the resulting water vapor will both cool the flaming front and dilute flammable gases (Albini 1976, Shafizadeh et al. 1977). Variation in moisture of living fuels has strong effects on flammability, but moisture of dead excised litter fuels can also vary. Moisture of litter fuels varies with climate, with seasons and with short term weather within a season.  Therefore, the rate of drying and flammability at any particular moisture content are key parameters that influence the fuel flammability throughout the fire season.  If species differ in the rate of drying following a precipitation event, this may strongly influence relatively flammability across species at any particular time post-wetting.  Such differential moisture content across time, may contribute to the often high spatial heterogeneity of surface fires (Pickett et al. 1999, Keeley et al. 2009). Fuel moisture dynamics of leaf litter are probably dependent upon forest structure (shading and rain throughfall effects), litter physical structure, and chemical composition of the fuelbeds (Swift et a. 1979, Hille \& Stephens 2005, Nelson \& Hiers 2008, Matthews 2014).

Fuel moisture content through time is controlled by two main processes, absorptive capacity and rate of moisture loss (Kreye et al. 2013). Absorptive capacity represents the potential maximum fuel moisture and is evaluated by the moisture content of litter when saturated. After saturation, the differences in moisture content indicate different abilities to retain moisture. The ability of litter to absorb and desorb water should be dependent on leaf and/or litter geometry, however, which traits control these processes are largely unknown. I propose two different sets of traits responsible for variation in the two processes mentioned: leaf particle geometry and litter bulk density. Litter characteristics such as surface-area-to-volume ratio, litter bulk density (Gibos 2010), mass density, particle size and shape, and chemical traits (Nelson 2001) influence moisture diffusion through litter. Litter packing has two pathways of effect on fire behavior: directly by its effect on oxygen availability for combustion, and indirectly by its effect on dry-down rate, and both these pathways are affected by leaf litter traits (such as leaf size, litter bulk density). Fuelbeds composed of larger leaves with lower moisture retainability and decomposition rates favor drying, thus increasing the probability of ignition and fire spread rate. 
Species traits may interact such that the flammability of multi-species mixtures is not the average of the constituent species (van Altena et al. 2012, de Magalhães \& Schwilk 2012, Blauw et al. 2015).  Such non-additive effects have been shown to be synergistic in dry litter fuels where the flammability of a mixture is driven by the most flammable species (de Magalhães \& Schwilk 2012, van Altena et al. 2012). In most forests, leaf litter will be a mixture representative of the species in the stand. It is possible that similar non-additive effects may influence litter moisture content, especially if different leaf traits influence adsorptive capacity and drying rate. Recent work by Blauw et al. (2015) suggests that moisture content can contribute to non-additive effects on heathland flammability, but the mechanism of this effect is not known. I investigated non-additive effects on both moisture content and the flammability of litter mixtures varying in time since wetting and in moisture content. I expect that litter mixtures will differ in their bulk density and thus, will dry at different rates.

I investigated species trait effects on litter moisture dynamics and consequent litter flammability across eight tree species in a temperate fire-prone forest in California. I investigated the relationship between traits such as leaf thinness and litter bulk density with the processes of moisture absorption and desorption. I determined the rate of moisture loss, the moisture of extinction (the threshold representing the moisture value above which fire will not ignite or spread) and the influence of moisture on the flammability of eight species from a mixed-conifer forest in California. I performed burn trials on leaf litter at various moisture levels and determined how time since wetting influenced time to ignition and flame spread rate. The burn trials were also performed with mixtures to evaluate if species contribute equally to litter moisture dynamics or if there are non-additive effects. I studied whether the non-additive effects on flammability reported in previous studies (de Magalhães \& Schwilk 2012, van Altena et al. 2012) occur under ecologically-relevant moisture levels and whether fuel moisture effects strengthen or mask such non-additivity.
...
Field sites for this study were located in Sequoia and Kings Canyon National Parks, California, USA (36 36N, 118 42 W) between 1600 and 2400 m elevation in mixed-conifer forest. I chose eight tree species that are representative of this type of forest: \emph{Pinus jeffreyi} Grev. \& Balf., \emph{Pinus lambertiana} Dougl., \emph{Pinus ponderosa} Dougl. ex Laws., \emph{Abies concolor} (Gord. \& Glend.) Lindl. ex Hildebr., \emph{Abies magnifica} A. Murr., \emph{Calocedrus decurrens} (Torr.) Florin, \emph{Quercus kelloggii} Newb., and \emph{Sequoiadendron giganteum} (Lindl.) J. Buchholz. In this study, I consider litter the top layer of leaves and small twigs less than 0.625 cm diameter (= 1-hour fuel, Fosberg 1970) that have fallen in the previous year (mostly undecomposed). I collected the leaf litter in the summer (mid-June to mid-July) in 2011 and in 2012 from 21 separate sites across the study area. Effort was made to collect from different populations (minimum of four, each population separated from the others by 9 to 32 km) for each species to control for plastic and ecotypic effects. An exception to this involved the litter from A. magnifica which is restricted to the higher elevations and could only be collected from one area, due to logistical constraints. Within that area, \emph{A. magnifica} litter was collected from over 10 different individuals. For the remaining species, the collection involved 2-4 individual trees at each site, separated by at least 10 m. The litter was collect about 2 m away from the trunk to obtain a more uniform sample, because bark and heavier branches tend to fall closer to the tree trunk.

\subsection{Moisture absorption and desorption}


I produced dry-down curves to determine maximum water retainability (moisture absorption) and the rate of moisture content loss (moisture desorption) for each species and for four distinct mixtures. These curves allowed me to determine the rate at which a species loses moisture (approximated as exponential decay), and determine maximum water content following saturation and gravity draining.  Samples from the eight species (six replicates per species) and four mixtures (5 replicates) were placed in baskets constructed of aluminium screen. I used 450 g of litter (dry weight) per trial, and controlled for depth, by changing the size of the basket. Weight was measured by using a balance sensitive to 0.1 g (model XS16001L, Mettler Toledo, Columbus, OH). Samples were immersed in clear plastic storage bins filled with water (Figure 2.1) for 24 hours to fully saturate them. After saturation, the baskets were removed from the water, allowed to drain for 3 minutes, and samples weighed to measure maximum moisture content. The samples were then allowed to dry in a partially controlled environment kept at 21 C temperature and 30\% relative humidity, assessed via an iButton sensor (Maxim Integrated) placed over the samples.  During the dry-down process three subsamples were taken at 24 hour intervals and weighed. These subsamples were then oven dried for 24 hours at 100 C and re-weighed to assess moisture content. This was repeated until the final sample from a basket was less than10\% moisture.


 The dry-down curves indicated that the eight species varied in their moisture behavior (Figure 2). To determine a subset of species to use in the mixture trials, I performed analysis of contrast using lsmeans (package: lsmeans; Lenth 2016) to determine similarity between the species, which fell into four groups. I then selected one species from each group to include in the mixtures resulting in four distinct 3-species mixtures. 
...
I performed flammability tests across multiple moisture levels on monospecific litter beds and on mixed litter beds replicated 5 times. I measured flammability using a 150 cm long burn table, 15 cm wide and 15 cm tall, in which leaf litter was placed and the table gently shaken to allow settling. In my experience, this design allows fire behaviour to reach constant flame spread rates (de Magalhães and Schwilk 2012).  Two tall metal rulers equally spaced along the apparatus allow visual determination of maximum flame height and nine type K thermocouples attached to data loggers measured temperature every second at three distances from the ignition point and at three different depths below the litter surface. Litter was ignited with a single ignition source (propane torch; maximum adiabatic flame temperature of 1899 C, http://www.benzomatic.com/products/fuel.aspx) at one end of the apparatus and allowed to burn until extinction. If a species at a specific moisture level failed to ignite after three attempts, no further attempts were made.  A timer was used to record time to ignition and duration of flaming combustion. The flammability trials followed the methodology detailed on de Magalhães and Schwilk (2012). 

During flammability trials, I measured time to ignition (s), duration of flaming combustion (s), spread rate (mm/s), calculated by dividing the length of the burned surface by the time it takes the flaming front to reach the end of the apparatus, maximal flame height (mm), and mass loss (\%), calculated as the difference between fuel mass before and after flame extinction (Anderson 1970, Cornelissen et al. 2003, Ormeño et al. 2009). I also measured duration above 100 C, or the length of time temperature exceeded 100 C, and temperature integration, which integrates duration of combustion and temperature above 100 C and serves as a proxy for heat release (de Magalhães and Schwilk 2012, Cornwell et al. 2015). By performing the flammability tests at several moisture levels I were able to determine moisture of extinction (a threshold representing the moisture value above which litter will not ignite or spread) for all species in this study, using a logistic regression.

Burn trials occurred in a cement structure used to simulate house fires at the Fire Department of the City of Lubbock.  Though not completely air tight, this structure minimizes wind and helps regulate temperature and relative humidity. Temperature and relative humidity were measured before every trial using a Kestrel 3000 (Nielsen-Kellerman, Boothwyn, PA). To minimize temperature and relative humidity variation, I conducted trials between 10 am and 3 pm. 

\subsection{Statistical analyses}


Dry-down curves (Figure 2.2) were created based on all data points collected, fitted with an exponential curve to each species:

%m = mmax e-λt								Eq. 1


Were m is moisture content at time t, and $\lambda$ is the exponential decay constant. I used a liner mixed-effects model taking the natural logarithm of moisture content, with time since wetting and species as fixed effects and nested within replicate. I extracted the coefficients of the fitted model to describe maximum water retainability (mmax; g of water per g of dry mass) and desiccation index ($\lambda$) for each species. I used post-hoc Tukey tests (package: lsmeans; Lenth 2016) to discriminate species’ behavior in terms of maximum water retainability and desiccation index. I analysed the influence of leaf size and litter bulk density on moisture dynamics (maximum water retainability and desiccation index) using linear nested models and used anova to determine which traits influenced the two processes. The effect of time since wetting on flammability was modelled using linear regression with the interaction between time since wetting and genus specified and with average vapor pressure deficit in the burning room during that trial as predictor. Differences across species were tested with post-hoc Tukey tests. A binomial logistic regression was fitted to the probability of ignition to obtain moisture of extinction.
I investigated non-additive effects on moisture and on flammability by testing if moisture content and flammability of mixtures were predicted by the average of the constituent species. I created the predicted values using the models that determine the relationship between moisture content/flammability and time since wetting for individual species, and then averaging the results obtained for the species in a mixture. This procedure was done for both moisture content and flammability parameter values of the constituent species. The expectation from the null model is that the difference between observed and predicted values of flammability will be zero. The null model is created by averaging the moisture content and the flammability of the individual species comprising the mixture for each time since wetting measured. I tested whether there were significant departures from the null (zero) with a mixed effects linear model (package: lme4; Bates et al. 2015). All analyses were conducted in R v.3.3.1 (R Core Team 2016).
...
There are marked differences in the extent of moisture species retain, seen as the maximum moisture content at time 0 (y-axis intercept, Fig. 2.2). Q. kelloggii, the only broadleaf, is the species that retains more moisture. Tukey tests on the linear mixed-effects model discriminated the species into three different maximum water retention groups: 1) Q. kelloggii; 2) P. lambertiana and C. decurrens; and 3) A. magnifica, S. giganteum, A. concolor and P. jeffreyi. P. ponderosa could not be discriminated between the last two groups. There are also marked differences in the desiccation rate of the eight species and the Tukey tests discriminated species into three groups: 1) Pinus; 2) the Cupressaceae; and 3) Q. kelloggii in between. C. decurrens is among the species with the lowest moisture retainability and is the species with the slower desiccation. Species with lower litter bulk density, such as Q. kelloggii and the pines, have higher desiccation rates than all other species.

The regression between maximum water retention and leaf litter traits showed that maximum water retention was significantly affected by a measure of leaf size (particle length/thickness; p=0.0369) but not by a characteristic of the litter bed (bulk density), indicating that the ability to absorb water is particle-dependent and a feature of a leaf’s morphology and/or chemistry (Table 2.1). Desiccation rate was significantly affected by litter bulk density but not leaf thinness (p=0.8794), indicating that desiccation rate is controlled by the emergent properties of the fuelbed. This is explained by the fact that more aerated fuel beds will facilitate evaporation, due to increased diffusion of water molecules from the leaf surface.

\subsection{Time since wetting and its effect on flammability}

Time since wetting was modelled against time to ignition and spread rate using genus as a fixed effect, because in a previous study (de Magalhães and Schwilk 2012) I observed that species flammability grouped around genus. Both models showed significant effects
