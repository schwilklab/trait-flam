...
litter fuels can also vary. In particular, fine dead fuels respond readily
...
measurements related to heat release or heat total transfer
...
being associated with flame heights and area burned, and with total heat
...
ignition and fire spread. The interaction of these processes, especially in
species mixtures, is poorly known.
...
differences in litter moisture absorption and drying rates could change the
...
replicates per species) and four mixtures (five replicates per mixture type) were
...
drying compared with field conditions because the baskets were suspended in air that was
...
flame spread rates within the range of rates reported for field burns \citep{Magalhaes+Schwilk-2012}. Two metal rulers equally
...
for two days of burning trials, therefore we have omitted temperature
...
\ref{fig:mixture_obs_pred_consume}), indicating the importance of non-additive effects.
...
followed by the finest-needled pine, \emph{P. lambertiana}. We expect that
decomposition will affect these dynamics. For example, Van Wagner
\citeyear{Van_Wagner-1969}, investigating fuel weathering, found that pine
needles had a variation in moisture content 3 to 6 times greater when they
...
behavior types observed in single species trials. Drying rates, however, did
not behave as the average of the constituent species: mixtures tended to be
drier than expected early in the process and wetter than expected later (Fig.
