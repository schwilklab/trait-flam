...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/fig9_mixture_obs_vs_pred_mc.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/fig10_mixture_obs_vs_pred_spread.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/fig11_mixture_obs_vs_pred_consume.pdf}
