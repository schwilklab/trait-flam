...
\begin{figure}[H]
  \centering
  \label{SI_fig2}
  \includegraphics[width=16cm]{figs_tables/SI_fig2_max_water_emmeans.pdf}
...
\begin{figure}[H]
  \centering
  \label{SI_fig3}
\includegraphics[width=16cm]{figs_tables/SI_fig3_dessication_emmeans.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/SI_fig4_SLA_maxMC.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/SI_fig5_di_bd.pdf}
...
\begin{figure}[H]
  \centering
\includegraphics[width=8cm]{figs_tables/SI_fig6_mixture_drydown-curves.pdf}
